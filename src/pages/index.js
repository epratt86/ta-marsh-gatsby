    ...
    <Layout>
      ...
      <section id={strip}>
        ...
        <div className={section}>
          ...
          <p>
            ...
            your expectations and requirements. With our company you will spend
            less than you think and the final results will be more than
            desirable for you.
          </p>
        </div>
        <div className={section}>
          ...
          <p>
            We maintain a staff of skilled roofers, sheet metal, carpenters and
            inspectors for construction defect and non litigation inspections.
            We provide services for Commercial, Industrial and Residential
            projects. Our areas of service include California, Arizona and
            Nevada.
          </p>
        </div>
      </section>
      <div id={contact} style={{ background: "#007bff" }}>
        <div className="container">
          ...
          <h6>Fill out this form to get in touch</h6>
          <ContactForm />
        </div>
      </div>
    </Layout>
